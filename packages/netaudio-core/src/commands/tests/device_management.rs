...
fn system_reset_modes_match_authentic_a32_frames() {
    ...
    assert_eq!(
        ...
        bytes_from_hex("ffff002418a400003e42274cff240000417564696e617465073a00900000006400010000")
    );
    assert_eq!(
        build_factory_reset(mac, 0x18A4).unwrap(),
        bytes_from_hex("ffff002418a400003e42274cff240000417564696e617465073a00900000006400010001")
    );
    assert_eq!(
...
fn lock_reset_probe_matches_shipping_controller_request() {
    assert_eq!(
        ...
        bytes_from_hex("ffff002018c100003e42274cff240000417564696e617465073a100800000064")
    );
}
...
fn switch_configuration_probe_matches_shipping_controller_request() {
    assert_eq!(
        ...
        bytes_from_hex("ffff002497be00003e42274cff240000417564696e617465073a00150000006400000000")
    );
    assert_eq!(
...
fn clear_configuration_requests_match_authentic_a32_frames() {
    ...
    assert_eq!(
        ...
        bytes_from_hex("ffff002401ed0000fec9ca09a6d50000417564696e617465073e00770000006400000000")
    );
    assert_eq!(
        build_clear_all_configuration(mac, 0x01ED).unwrap(),
        bytes_from_hex("ffff002401ed0000fec9ca09a6d50000417564696e617465073e00770000006400000001")
    );
    assert_eq!(
        build_clear_all_configuration_preserving_internet_protocol_settings(mac, 0x01ED).unwrap(),
        bytes_from_hex("ffff002401ed0000fec9ca09a6d50000417564696e617465073e00770000006400000002")
    );
    assert_eq!(
