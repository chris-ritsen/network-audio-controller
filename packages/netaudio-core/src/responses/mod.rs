...
const TRANSMITTER_CHANNEL_STATUS_FORMAT_SIZE: usize = 16;
...
const RECEIVER_CHANNEL_STATUS_FORMAT_SIZE: usize = 16;
const RECEIVER_FLOW_STATUS_POINTER_TABLE_OFFSET: usize = 18;
