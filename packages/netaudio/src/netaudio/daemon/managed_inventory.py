...
def _managed_device_json(observation: ManagedDeviceObservation, synced_at: float, fresh: bool) -> dict:
    ...
    record = {
        ...
        "ddm_product_version": identity.product_version if identity else None,
        "ddm_product_software_version": identity.product_software_version if identity else None,
        "ddm_dante_version": identity.dante_version if identity else None,
        "ddm_dante_hardware_version": identity.dante_hardware_version if identity else None,
        ...
        "field_sources": {
            ...
            "availability": "ddm",
            "clock": "ddm",
            "ddm_product_version": "ddm",
            "ddm_product_software_version": "ddm",
            "ddm_dante_version": "ddm",
            "ddm_dante_hardware_version": "ddm",
        },
        **metadata,
    }
