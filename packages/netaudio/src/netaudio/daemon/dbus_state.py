...
DANTE_PROPERTY_NAMES = {
    ...
    "aes67_configuration_supported": "Aes67ConfigurationSupported",
    "aes67_configuration_support_known": "Aes67ConfigurationSupportKnown",
    ...
    "rom_boot_version": "RomBootVersion",
    "product_version": "ProductVersion",
    "friendly_product_version": "FriendlyProductVersion",
    "manufacturer_software_version": "ManufacturerSoftwareVersion",
    "manufacturer_firmware_version": "ManufacturerFirmwareVersion",
    "cmc_server_version": "CmcServerVersion",
    "router_protocol_version": "RouterProtocolVersion",
    "ddm_product_version": "DdmProductVersion",
    "ddm_product_software_version": "DdmProductSoftwareVersion",
    "ddm_dante_version": "DdmDanteVersion",
    "ddm_dante_hardware_version": "DdmDanteHardwareVersion",
...
def snapshot_dante_device(device):
    return {
        ...
        "platform_model_name": dbus_string(device.platform_model_name),
        ...
        "aes67_configuration_supported": device.aes67_configuration_supported is True,
        "aes67_configuration_support_known": device.aes67_configuration_supported is not None,
        ...
        "rom_boot_version": dbus_string(device.rom_boot_version),
        "product_version": dbus_string(device.product_version),
        "friendly_product_version": dbus_string(device.friendly_product_version),
        "manufacturer_software_version": dbus_string(device.manufacturer_software_version),
        "manufacturer_firmware_version": dbus_string(device.manufacturer_firmware_version),
        "cmc_server_version": dbus_string(device.cmc_server_version),
        "router_protocol_version": dbus_string(device.router_protocol_version),
        "ddm_product_version": dbus_string(device.ddm_product_version),
        "ddm_product_software_version": dbus_string(device.ddm_product_software_version),
        "ddm_dante_version": dbus_string(device.ddm_dante_version),
        "ddm_dante_hardware_version": dbus_string(device.ddm_dante_hardware_version),
