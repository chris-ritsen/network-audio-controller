const REASON_TEXT = {
  ...
  read_only_unknown: "The device did not report whether this setting is read-only.",
  state_unavailable: "Current and configured redundancy state is unavailable.",
  state_stale: "The last redundancy state is stale.",
  available_modes_unknown: "The device did not report available redundancy modes.",
  available_modes_stale: "The last reported redundancy modes are stale.",
  available_modes_empty: "The device explicitly reported no known redundancy modes.",
  requested_mode_not_advertised: "The requested redundancy mode was not advertised by the device.",
  serializer_unavailable: "The advertised mode has no supported serializer value.",
  transport_unavailable: "No supported control transport is available for this operation.",
  ...
  protocol_unsupported:
    "The reported protocol cohort does not support this operation.",
