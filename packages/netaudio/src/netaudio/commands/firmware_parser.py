...
from netaudio.commands.firmware_capabilities import _extract_capability_14, _extract_capability_9, _read_str
...
from netaudio.commands.firmware_validation import _validate_dnt_checksums
