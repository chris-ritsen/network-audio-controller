...
class DanteDevice:
    def __init__(self, server_name="", dump_payloads=False, debug=False, app=None):
        ...
        self.aes67_configuration_supported: bool | None = None
        self.aes67_configured_property_advertised: bool | None = None
        self.dante_model_record_protocol_version: int | None = None
        self.dante_model_primary_capabilities: int | None = None
        self.dante_model_read_only_capabilities: int | None = None
        self.dante_model_monitoring_capabilities: int | None = None
        self.dante_model_secondary_capabilities: int | None = None
        self.dante_model_domain_capability_values: int | None = None
        self.dante_model_domain_capability_validity: int | None = None
        self.identify_supported: bool | None = None
        self.sample_rate_configuration_supported: bool | None = None
        ...
        self.requested_encoding: int | None = None
        self.encoding_update_mode: int | None = None
        ...
        self.codec_parameters: list[dict] | None = None
        self.gain_adapter: dict | None = None
        self.bit_depth: int | None = None
        self.platform_software_version: str | None = None
        self.platform_hardware_version: str | None = None
        self.platform_api_version: str | None = None
        self.rom_boot_version: str | None = None
        self.manufacturer_software_version: str | None = None
        self.manufacturer_firmware_version: str | None = None
        self.friendly_product_version: str | None = None
        self.cmc_server_version: str | None = None
        self.router_protocol_version: str | None = None
        self.ddm_product_version: str | None = None
        self.ddm_product_software_version: str | None = None
        self.ddm_dante_version: str | None = None
        self.ddm_dante_hardware_version: str | None = None
        self.clock_diagnostics: dict | None = None
        self.clock_status: dict | None = None
        self.clock_observed_at: str | None = None
        self.ptpv1_grandmaster_uuid: str | None = None
        self.supported_clock_sources: list[int] | None = None
        ...
        self.ptpv1_device_uuid: str | None = None
        self.ptpv1_master_uuid: str | None = None
        ...
        self.platform_model_name: str | None = None
        self.platform_model_identifier: str | None = None
        self.platform_versions_record: dict | None = None
        self.manufacturer_versions_record: dict | None = None
        ...
        self.managed_operation_permissions: dict[str, bool] | None = None
